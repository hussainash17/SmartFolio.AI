...
from .portfolio import Portfolio  # runtime import to resolve relationship targets
from .order import Order          # runtime import to resolve relationship targets
from .trade import Trade          # runtime import to resolve relationship targets

if TYPE_CHECKING:
    # These remain for typing; runtime imports above ensure mapper resolution
