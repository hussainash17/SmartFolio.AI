...
export function useAvailableBenchmarks(p0: { enabled: boolean; }) {
    return useQuery({
...
export function useMonthlyReturns(portfolioId: string | null, year?: number, p0?: { enabled: boolean; }) {
    return useQuery({
...
export function useSecurityAttribution(portfolioId: string | null, period: string = 'YTD', limit: number = 10, p0: {
    enabled: boolean;
}) {
    return useQuery({
...
export function useSectorAttribution(portfolioId: string | null, period: string = 'YTD', benchmarkId?: string, p0?: {
    enabled: boolean;
}) {
    return useQuery({
