...
import { TrendingUp, TrendingDown, Minus, Activity, BarChart2, PieChart } from 'lucide-react';
...
const MarketBreadth: React.FC = () => {
    ...
    return (
        <Card className="h-full border-none shadow-sm flex flex-col">
            ...
            <CardContent className="flex-1 flex flex-col justify-between px-4 pb-4 gap-4">
